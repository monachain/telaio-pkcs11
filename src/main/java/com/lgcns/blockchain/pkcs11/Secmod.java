...
public final class Secmod {
    ...
    public static final class Module {
        ...
        private BlockchainPKCS11 provider;
        ...
        void setProvider(BlockchainPKCS11 p) {
            if (provider != null) {
        ...
        private BlockchainPKCS11 newProvider() {
            try {
                InputStream in = new ByteArrayInputStream(config.getBytes("UTF8"));
                return new BlockchainPKCS11(in);
            } catch (Exception e) {
                // XXX
                throw new ProviderException(e);
            }
    ...
    private static Map<Bytes,TrustAttributes> getTrust(BlockchainPKCS11 provider)
            throws PKCS11Exception {
