 ...
 * @since   1.5
 */
public final class BlockchainPKCS11 extends AuthProvider {
    ...
    // written by lgcns
    private static final String defConfigName = "pkcs11.conf";
    private File defConfigFile = new File(defConfigName);
    ...
    public BlockchainPKCS11() {
    	// updated by lgcns for default configuration
		this(System.getProperty("com.lgcns.blockchain.pkcs11.Config", defConfigName));
//    	if (defConfigFile.exists() == false) {
//    		System.out.printf("", );
//            throw new ProviderException("BlockchainPKCS11 requires configuration file argument");
//    	}
...
//            ("SunPKCS11 requires configuration file argument");
    ...
    public BlockchainPKCS11(String configName) {
        this(checkNull(configName), null);
    }

    public BlockchainPKCS11(InputStream configStream) {
     ...
     */
    @Deprecated
    public BlockchainPKCS11(String configName, InputStream configStream) {
        super("SunPKCS11-" +
    ...
    private static class TokenPoller implements Runnable {
        private final BlockchainPKCS11 provider;
        private volatile boolean enabled;
        private TokenPoller(BlockchainPKCS11 provider) {
    ...
    private static class SunPKCS11Rep implements Serializable {
        ...
        SunPKCS11Rep(BlockchainPKCS11 provider) throws NotSerializableException {
        ...
        private Object readResolve() throws ObjectStreamException {
            BlockchainPKCS11 p = (BlockchainPKCS11)Security.getProvider(providerName);
